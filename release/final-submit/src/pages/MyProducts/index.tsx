...
export function MyProducts() {
  ...
  const referenceImage = !hasRegisteredProduct
    ? "/my-products-empty-reference.svg"
    : hasWrittenProduct
      ? "/my-products-reference.svg?v=20260821-written"
      : "/my-products-before-written.svg?v=20260821-before-written";

  return (
    <section className={styles.page} aria-label="my products page" data-has-registered-product={hasRegisteredProduct}>
      <img
      ...
      <div className={styles.actions} aria-label="product actions">
        <ActionIcon />
        <Link to="/product-add" state={{returnTo: "/my-products"}} className={styles.addHotspot} aria-label="제품 추가" />
